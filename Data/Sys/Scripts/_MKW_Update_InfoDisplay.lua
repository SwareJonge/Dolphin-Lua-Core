...
function onScriptUpdate()
  if Pointers.getPlayerBasePointer() ~= 0 and not RaceHasStarted then
    RaceHasStarted = true
    SetInfoDisplay() --function that tells to turn on/off InfoDisplay
  ...
  elseif Pointers.getPlayerBasePointer() == 0 and RaceHasStarted == true then
